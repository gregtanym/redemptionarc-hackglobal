          ...
          return (
              <div className="flex w-full h-44 items-start" key={index}>
                  ...
                  <div className="flex flex-col items-center ml-4">
                      <div
                          className="bg-white flex flex-col justify-center items-center border border-date-card-border h-12 w-12 rounded-lg p-3">
                  ...
                  {/*images*/}
                  <div
                      className="relative ml-5 mb-3 w-full h-40 cursor-pointer mr-4 group transform transition-transform duration-300 ease-in-out hover:scale-105">
                      ...
                      >
                          <div
                              className="absolute bottom-9 left-4 w-full flex items-end justify-start text-white text-lg font-regular">
                              <MapPin size={23} className="mr-2"/>
                              <p>{event.location}</p>
                          </div>
                          <div
                              className="absolute bottom-3 left-4 w-full flex items-end justify-start text-white text-lg font-bold">
